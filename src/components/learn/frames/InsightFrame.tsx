    ...
    <div className="flex flex-col items-center justify-center h-full px-6 text-center">
      <div className="flex flex-col items-center gap-5 max-w-sm">
        <div className="space-y-2">
          ...
          <div className="text-5xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-emerald-300 to-emerald-500 tabular-nums">
            {card.impactValue}
          </div>
        </div>

        <p className="text-base text-zinc-100 font-bold leading-snug">
          {card.insight}
        </p>

        {personalized && (
          <div className="w-full p-3 bg-emerald-500/5 border border-emerald-500/15 rounded-2xl text-left flex items-start gap-2.5">
